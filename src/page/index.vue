    ...
    <div class="mainBox flexBox">
      ...
      <div class="center">
        <div class="frame">
          ...
          <ul class="list">
            <li
              v-for="(item, idx) in room"
              :class="idx == roomIdx ? 'active' : ''"
              class="txtOver"
              @click="changeRoomIdx(idx)"
            >
              <span>
                <el-badge
                  class="badge"
                  v-if="idx === roomIdx ? true : false"
                  value="12"
                />
              </span>
              <span>{{ item.labName }}</span>
            ...
            <div class="swiper" id="room">
              <div class="swiper-wrapper">
                <div class="swiper-slide" v-for="(item, idx) in room">
                  <div
                    class="bodyInfo flexBox"
                    :class="tagList[item.labStatus].class"
                  >
              ...
              <li class="flexBox">
                ...
                <div class="info">
                  <p
                    class="val"
                    :class="
                      onLine.sensorInfo.temperatureState == '异常'
                        ? 'active'
                        : ''
                    "
                  >
              ...
              <li class="flexBox">
                ...
                <div class="info">
                  <p
                    class="val"
                    :class="
                      onLine.sensorInfo.humidityState == '异常' ? 'active' : ''
                    "
                  >
                    {{
                      onLine && Boolean(onLine.sensorInfo)
              ...
              <li class="flexBox">
                ...
                <div class="info">
                  <p
                    class="val"
                    :class="
                      onLine.sensorInfo.illuminationState == '异常'
                        ? 'active'
                        : ''
                    "
                  >
              ...
              <li class="flexBox">
                ...
                <div class="info">
                  <p
                    class="val"
                    :class="
                      onLine.sensorInfo.electromagnetismState == '异常'
                        ? 'active'
                        : ''
                    "
                  >
      ...
      <div class="right">
        <div class="quality">
          ...
          <div class="content">
            <div style="color: #45c2ff">合格率：90%</div>
            <div style="color: #ffd635">不合格率：10%</div>
          </div>
